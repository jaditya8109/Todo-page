So this is basically TODO app based on NodeJS.

All the dependenciess have been mentioned and do not forget to install them before running it on your computer. 

Also database is created in local computer only so u need to download mongodb compass and robo3t(to view your data) 
to use local computer as databse or online cloud can be used(like mongodb atlas). 
...
And then open 3rd command prompt to run app.js file by node app.js
